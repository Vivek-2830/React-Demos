...
const Counter = () => {
    ...
    const [titelState, setTitleState] = useState("Fun");
    ...
    return (
        <div className="col-12 col-md-4 offset-md-4 border  text-white">
            <span className="h2 pt-4 m-2 text-white-50">{titelState} Counter </span>
            <br />
            <button className="btn btn-success m-1" onClick={incrementCounter}>+1</button> 
            <button className="btn btn-danger m-1" onClick={decrementCountr}>-1</button> <br />
            <span className="h4">
                Counter: &nbsp;
